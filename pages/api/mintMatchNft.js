...
const mintMatchNft = async (req,res) => {
    ...
    const metadata = {
        ...
        description: `${req.body.names[0].split(' ')[0]} & ${req.body.names[1].split(' ')[0]} just matched!`,
    ...
    const metadataFile = new Moralis.File('file.json', { base64: base64 })
    ...
    res.status(200).send({ message: 'success', data: { tx: tx, txReceipt: txReceipt } })
}
